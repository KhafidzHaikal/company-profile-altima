			...
			<table className="min-w-full border-separate border-spacing-y-3">
				...
				<tbody className="dark:text-white text-sm font-light">
					<tr className="hover:bg-neutral-800 hover:text-white transition rounded-md">
						...
						<td className="px-3 py-3">Akomodasi (9 malam)</td>
						<td className="px-3 py-3 text-right">Rp 3.200.000</td>
					</tr>
					<tr className="hover:bg-neutral-800 hover:text-white transition rounded-md">
						<td className="px-3 py-3">2</td>
						<td className="px-3 py-3">Transportasi Lokal + Guide + Handling</td>
						<td className="px-3 py-3 text-right">Rp 2.300.000</td>
					</tr>
					<tr className="hover:bg-neutral-800 hover:text-white transition rounded-md">
						<td className="px-3 py-3">3</td>
						<td className="px-3 py-3">Tiket Wisata & Aktivitas</td>
						<td className="px-3 py-3 text-right">Rp 2.970.000</td>
					</tr>
					<tr className="hover:bg-neutral-800 hover:text-white transition rounded-md">
						<td className="px-3 py-3">4</td>
						<td className="px-3 py-3">Tiket Pesawat Domestik (4x Rute)</td>
						<td className="px-3 py-3 text-right">Rp 4.800.000</td>
					</tr>
					<tr className="hover:bg-neutral-800 hover:text-white transition rounded-md">
					...
					<tr className="text-[#112A90] font-bold border-t border-[#112A90] text-sm">
						...
						<td className="px-3 py-3 text-right">Rp 15.270.000</td>
					</tr>
				</tbody>
			</table>
		</div>
