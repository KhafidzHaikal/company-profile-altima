...
import Dubai2DudeTabs from "./components/TabDetail";
				...
				<div className="lg:flex justify-between items-center gap-4">
					<div className="">
						...
						<p className={`${lilyFont.className} text-2xl md:text-4xl`}>
							Paket Liburan Keluarga ke Dubai (4 Hari 3 Malam)
						</p>
						<p className="text-[#112A90] dark:text-white flex items-center mt-4 font-medium text-md">
						Rp 29.500.000/ keluarga (2 dewasa + 1 anak)
						</p>
						<p className="text-[#4C5E70] mt-2 mb-4 lg:mb-8 text-sm">
							Kami memberikan liburan ke tempat-tempat bersejarah yang berada di
							kota Dubai bersama keluarga.
						</p>
						<Link href={""}>
